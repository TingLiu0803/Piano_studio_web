...
/** Practice Pomodoro + backyard cats (kids adopt one electronic cat). */
export const PRACTICE_TIMER_URL =
  "https://mianbao-practice-timer.onrender.com/practice";
...
export const practiceGames: PracticeGame[] = [
  ...
  {
    id: "practice-timer",
    url: PRACTICE_TIMER_URL,
    title: {
      en: "Mianbao Practice Timer",
      zh: "面包练习计时",
    },
    skill: {
      en: "A practice Pomodoro plus a backyard of cats. Sit down, start the timer, earn dried fish, then add toys and plants so other cats come to visit.",
      zh: "番茄钟加上后院猫咪。坐下、按下计时，练琴换小鱼干，再用小鱼干给后院添东西，吸引别的猫来做客。",
    },
    audience: {
      en: "Every child who comes to a lesson can adopt one electronic cat as a practice partner. Adults who want one are welcome too.",
      zh: "每一个来上课的小朋友都可以领养一只电子猫陪练琴。大朋友愿意的话，也可以领一只。",
    },
    screenshot: {
      src: "/studio/games/practice-timer.png",
      alt: {
        en: "Mianbao Practice Timer at Eric Liu Piano Studio: a 25-minute practice clock next to an illustrated orange-and-white cat at a piano",
        zh: "Eric Liu 钢琴工作室面包练习计时截图：25 分钟练琴计时，旁边是橘白猫坐在钢琴前的插画",
      },
    },
  },
];
...
export const practiceGamesCopy: Record<Locale, PracticeGamesCopy> = {
  en: {
    navLabel: "Games",
    seo: {
      title: "Kids Piano Games | Beats, Notes & Practice Timer | Cupertino",
      description: `A warehouse of studio-made piano games for kids at Eric Liu Piano Studio in Cupertino. Live now: Beat Game, Who Am I?, and Mianbao Practice Timer. In follow-ups, focused lesson time increased by about ${extraFocusMinutes} minutes on average. Free trial.`,
    },
    badge: "Studio game warehouse",
    h1: "Piano games for kids: beats, note names, and a practice timer",
    intro:
    ...
    facts: [
      ...
      "Live now: Beat Game, Who Am I?, and Mianbao Practice Timer — built for kids, not advanced theory quizzes",
    ...
    catalogSubtitle:
      "Three titles are live. The next game will show up on this same shelf — name, screenshot, and a play button.",
    ...
    inviteBody: `Mianbao is the studio's people-loving orange-and-white cat. The kids' games start with beats, note names, and a practice timer with a backyard of cats — short rounds, then back to the piece. Families who tried them reported about ${extraFocusMinutes} extra minutes of focused lesson time.`,
    ...
    howWeUseBody:
      "A game is a named five-to-ten-minute task, not open-ended screen time. Beat Game for values and pulse; Who Am I? for note names; the practice timer to sit down and stay with the piece. Then close the tab — or keep the timer running — and play the assigned piece.",
    howWeUseBullets: [
  ...
  zh: {
    navLabel: "小游戏",
    seo: {
      title: "儿童钢琴小游戏｜节拍、音名与练琴计时｜库比蒂诺",
      description: `Eric Liu 钢琴工作室的儿童练琴游戏仓库。现已上线：节拍游戏、我是谁、面包练习计时。回访观察：小孩上课专注时间平均约多 ${extraFocusMinutes} 分钟。提供免费试听。`,
    },
    badge: "工作室游戏仓库",
    h1: "儿童钢琴小游戏：节拍、音名，还有练琴计时",
    intro:
      "这一页是工作室的游戏仓库。每张卡片都有名字和截图。以后每出新游戏都会摆在这里，不用再翻邮件。小游戏放在一对一钢琴课旁边用——不是用来取代私教。",
    quickAnswer: `工作室会定期推出给小孩玩的自制音乐小游戏。现在可以玩的是：节拍游戏（音符时值与节奏），「我是谁」（用小动物记音名，再弹儿歌），以及面包练习计时（番茄钟加上后院猫咪）。根据家长回访，上课专注时间平均约多了 ${extraFocusMinutes} 分钟，在家练琴意愿也有提升。后续新游戏都会出现在这个仓库里。小游戏是一对一教学的补充，不是替代。`,
    factsTitle: "一眼速览",
    factsEyebrow: "工作室观察",
    facts: [
      ...
      "现已上线：节拍游戏、我是谁、面包练习计时——给小孩玩，不是进阶乐理测验",
    ...
    catalogSubtitle:
      "目前上架三款。下一款也会出现在同一层货架上——名字、截图、开始玩。",
    playCta: "打开这款游戏",
    playNote: "将在新标签页打开。手机或电脑都可以；建议打开声音。",
    inviteEyebrow: "员工 001 号",
    inviteTitle: "招财猫 Mianbao 带你去游戏仓库",
    inviteBody: `Mianbao 是工作室一只非常亲人的橘白猫。给小孩的游戏从节拍、音名，以及带后院猫咪的练琴计时开始：短短一轮，再回到曲子。试过的家庭在回访里提到，上课专注时间大约多了 ${extraFocusMinutes} 分钟。`,
    invitePrimaryCta: "查看小游戏",
    invitePlayCta: "打开儿童小游戏",
    mianbaoCaption: "员工 001 号 Mianbao 坐在库比蒂诺工作室的纸箱仓库上。",
    howWeUseTitle: "小游戏怎么放进一周功课",
    howWeUseBody:
      "游戏是一个有名字的 5–10 分钟任务，不是打开屏幕随便玩。节拍游戏练时值和拍子；「我是谁」练音名；练琴计时用来坐下并把曲子弹完。然后关掉标签——或者让计时继续走——去弹这周的曲子。",
    howWeUseBullets: [
      "当作曲目前的热身，而不是取代曲目",
      "每轮保持够短，注意力才撑得住",
